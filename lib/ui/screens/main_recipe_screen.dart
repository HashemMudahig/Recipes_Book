...
class MainRecipeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<RecipeClass>(
      builder:
          (BuildContext context, myProvider, Widget? child) => Scaffold(
            appBar: AppBar(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: (() async {
                // DbHelper.dbHelper.clearAllRecipes();
            ...
            drawer: Drawer(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      await Provider.of<RecipeClass>(
                        context,
                        listen: false,
                      ).syncWithServer();
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('تمت المزامنة مع السيرفر')),
                      );
                    },
                    child: Text('مزامنة مع السيرفر'),
                  ),
                ],
              ),
            ),
